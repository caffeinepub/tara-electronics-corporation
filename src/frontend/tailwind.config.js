  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        body: ["Satoshi", '"Cabinet Grotesk"', "sans-serif"],
      ...
      boxShadow: {
        ...
        card: "0 2px 16px -4px rgba(30, 50, 120, 0.12)",
        "card-hover": "0 8px 32px -8px rgba(30, 50, 120, 0.2)",
        gold: "0 4px 20px -4px rgba(200, 140, 30, 0.4)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
