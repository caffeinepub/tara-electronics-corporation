...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: ProductCategory): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(arg0, arg1, arg2, arg3, to_candid_ProductCategory_n1(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: Array<OrderItem>, arg1: CustomerInfo): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async submitEnquiry(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "customisation" in value ? ProductCategory.customisation : "consumerElectronics" in value ? ProductCategory.consumerElectronics : "laserEngraving" in value ? ProductCategory.laserEngraving : "threeDPrinting" in value ? ProductCategory.threeDPrinting : value;
}
...
function from_candid_vec_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ProductCategory>): Array<ProductCategory> {
    return value.map((x)=>from_candid_ProductCategory_n6(_uploadFile, _downloadFile, x));
}
...
function to_candid_variant_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductCategory): {
    ...
    return value == ProductCategory.customisation ? {
        customisation: null
    } : value == ProductCategory.consumerElectronics ? {
        consumerElectronics: null
    } : value == ProductCategory.laserEngraving ? {
        laserEngraving: null
    } : value == ProductCategory.threeDPrinting ? {
        threeDPrinting: null
    } : value;
}
